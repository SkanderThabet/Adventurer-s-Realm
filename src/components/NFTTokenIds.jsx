              ...
              <Card
                ...
                actions={[
                  ...
                  <Tooltip title="View on Opensea">
                    <CodeSandboxOutlined
                      onClick={() => {
                        if (nft?.name === "Gold Collection") {
                          window.open(
                            "https://testnets.opensea.io/collection/gold-adventurers"
                          );
                        } else if (nft?.name === "Silver Collection") {
                          window.open(
                            "https://testnets.opensea.io/collection/silver-adventurers"
                          );
                        } else if (nft?.name === "Bronze Collection") {
                          window.open(
                            "https://testnets.opensea.io/collection/bronze-adventurers"
                          );
                        }
                      }}
                    />
